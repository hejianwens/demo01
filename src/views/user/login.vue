                    ...
                    <el-tabs v-model="activeName" @tab-click="handleClick" s>
                        ...
                        <el-tab-pane name="second">
                            ...
                            <div class="registInput" style="height:250px;width:350px;line-height:50px;padding: 22px;">
                                ...
                                <span style="float:left;padding-right:7px">呢称:</span>
                                <el-input v-model="registUser.nickName" placeholder="请输入手机" style="float:left;width:300px;"></el-input>
    ...
    export default {
        ...
        methods: {
            ...
            register() {
                ...
                if (_this.registUser.account == "") {
                ...
                else if (_this.registUser.nickName == "") {
                    window.alert("呢称不能为空");
                    return
                }
                else {
                    ...
                    axios({
                        ...
                        data: {
                            ...
                            nickName: _this.registUser.nickName,
                        }
                    })
                        .then(function (response) {
                            if (response.data.code == "200") {
